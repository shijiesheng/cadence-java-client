...
public final class EnumMapper {
  ...
  public static EventFilterType eventFilterType(com.uber.cadence.entities.HistoryEventFilterType t) {
    if (t == null) {
  ...
  public static QueryRejectCondition queryRejectCondition(com.uber.cadence.entities.QueryRejectCondition t) {
    if (t == null) {
  ...
  public static QueryResultType queryTaskCompletedType(com.uber.cadence.entities.QueryTaskCompletedType t) {
    if (t == null) {
      return QUERY_RESULT_TYPE_INVALID;
    }
    switch (t) {
  ...
  public static com.uber.cadence.entities.DecisionTaskFailedCause decisionTaskFailedCause(
    ...
    switch (t) {
      ...
      case DECISION_TASK_FAILED_CAUSE_BAD_REQUEST_CANCEL_ACTIVITY_ATTRIBUTES:
        return com.uber.cadence.entities.DecisionTaskFailedCause.BAD_REQUEST_CANCEL_ACTIVITY_ATTRIBUTES;
      ...
      case DECISION_TASK_FAILED_CAUSE_BAD_COMPLETE_WORKFLOW_EXECUTION_ATTRIBUTES:
        return com.uber.cadence.entities.DecisionTaskFailedCause.BAD_COMPLETE_WORKFLOW_EXECUTION_ATTRIBUTES;
      case DECISION_TASK_FAILED_CAUSE_BAD_FAIL_WORKFLOW_EXECUTION_ATTRIBUTES:
        return com.uber.cadence.entities.DecisionTaskFailedCause.BAD_FAIL_WORKFLOW_EXECUTION_ATTRIBUTES;
      case DECISION_TASK_FAILED_CAUSE_BAD_CANCEL_WORKFLOW_EXECUTION_ATTRIBUTES:
        return com.uber.cadence.entities.DecisionTaskFailedCause.BAD_CANCEL_WORKFLOW_EXECUTION_ATTRIBUTES;
      case DECISION_TASK_FAILED_CAUSE_BAD_REQUEST_CANCEL_EXTERNAL_WORKFLOW_EXECUTION_ATTRIBUTES:
        return com.uber.cadence.entities.DecisionTaskFailedCause.BAD_REQUEST_CANCEL_EXTERNAL_WORKFLOW_EXECUTION_ATTRIBUTES;
      ...
      case DECISION_TASK_FAILED_CAUSE_BAD_SIGNAL_WORKFLOW_EXECUTION_ATTRIBUTES:
        return com.uber.cadence.entities.DecisionTaskFailedCause.BAD_SIGNAL_WORKFLOW_EXECUTION_ATTRIBUTES;
      case DECISION_TASK_FAILED_CAUSE_BAD_START_CHILD_EXECUTION_ATTRIBUTES:
        return com.uber.cadence.entities.DecisionTaskFailedCause.BAD_START_CHILD_EXECUTION_ATTRIBUTES;
  ...
  public static com.uber.cadence.entities.CancelExternalWorkflowExecutionFailedCause
      cancelExternalWorkflowExecutionFailedCause(
          CancelExternalWorkflowExecutionFailedCause t) {
    switch (t) {
      ...
      case CANCEL_EXTERNAL_WORKFLOW_EXECUTION_FAILED_CAUSE_WORKFLOW_ALREADY_COMPLETED:
        return com.uber.cadence.entities.CancelExternalWorkflowExecutionFailedCause.WORKFLOW_ALREADY_COMPLETED;
    }
    throw new IllegalArgumentException("unexpected enum value");
  }
  ...
  public static com.uber.cadence.entities.SignalExternalWorkflowExecutionFailedCause
      signalExternalWorkflowExecutionFailedCause(
          SignalExternalWorkflowExecutionFailedCause t) {
    switch (t) {
      ...
      case SIGNAL_EXTERNAL_WORKFLOW_EXECUTION_FAILED_CAUSE_UNKNOWN_EXTERNAL_WORKFLOW_EXECUTION:
        return com.uber.cadence.entities.SignalExternalWorkflowExecutionFailedCause.UNKNOWN_EXTERNAL_WORKFLOW_EXECUTION;
      case SIGNAL_EXTERNAL_WORKFLOW_EXECUTION_FAILED_CAUSE_WORKFLOW_ALREADY_COMPLETED:
        return com.uber.cadence.entities.SignalExternalWorkflowExecutionFailedCause.WORKFLOW_ALREADY_COMPLETED;
    }
    throw new IllegalArgumentException("unexpected enum value");
  }

  public static com.uber.cadence.entities.ChildWorkflowExecutionFailedCause childWorkflowExecutionFailedCause(
      ChildWorkflowExecutionFailedCause t) {
    switch (t) {
