...
class HistoryMapper {
  ...
  static List<com.uber.cadence.entities.HistoryEvent> historyEventArray(List<com.uber.cadence.api.v1.HistoryEvent> t) {
    if (t == null) {
      return null;
    }
  ...
  static com.uber.cadence.entities.HistoryEvent historyEvent(com.uber.cadence.api.v1.HistoryEvent e) {
  ...
  static com.uber.cadence.entities.ActivityTaskCancelRequestedEventAttributes activityTaskCancelRequestedEventAttributes(
  ...
  static com.uber.cadence.entities.ActivityTaskCanceledEventAttributes activityTaskCanceledEventAttributes(
    ...
    com.uber.cadence.entities.ActivityTaskCanceledEventAttributes res = new com.uber.cadence.entities.ActivityTaskCanceledEventAttributes();
  ...
  static com.uber.cadence.entities.ActivityTaskCompletedEventAttributes activityTaskCompletedEventAttributes(
    ...
    com.uber.cadence.entities.ActivityTaskCompletedEventAttributes res = new com.uber.cadence.entities.ActivityTaskCompletedEventAttributes();
  ...
  static com.uber.cadence.entities.ActivityTaskFailedEventAttributes activityTaskFailedEventAttributes(
    ...
    com.uber.cadence.entities.ActivityTaskFailedEventAttributes res = new com.uber.cadence.entities.ActivityTaskFailedEventAttributes();
  ...
  static com.uber.cadence.entities.ActivityTaskScheduledEventAttributes activityTaskScheduledEventAttributes(
    ...
    com.uber.cadence.entities.ActivityTaskScheduledEventAttributes res = new com.uber.cadence.entities.ActivityTaskScheduledEventAttributes();
    res.setActivityId(t.getActivityId());
  ...
  static com.uber.cadence.entities.ActivityTaskStartedEventAttributes activityTaskStartedEventAttributes(
    ...
    com.uber.cadence.entities.ActivityTaskStartedEventAttributes res = new com.uber.cadence.entities.ActivityTaskStartedEventAttributes();
    res.setScheduledEventId(t.getScheduledEventId());
    res.setIdentity(t.getIdentity());
  ...
  static com.uber.cadence.entities.ActivityTaskTimedOutEventAttributes activityTaskTimedOutEventAttributes(
    ...
    com.uber.cadence.entities.ActivityTaskTimedOutEventAttributes res = new com.uber.cadence.entities.ActivityTaskTimedOutEventAttributes();
    res.setDetails(payload(t.getDetails()));
    res.setScheduledEventId(t.getScheduledEventId());
    res.setStartedEventId(t.getStartedEventId());
  ...
  static com.uber.cadence.entities.CancelTimerFailedEventAttributes cancelTimerFailedEventAttributes(
    ...
    com.uber.cadence.entities.CancelTimerFailedEventAttributes res = new com.uber.cadence.entities.CancelTimerFailedEventAttributes();
  ...
  static com.uber.cadence.entities.ChildWorkflowExecutionFailedEventAttributes childWorkflowExecutionFailedEventAttributes(
  ...
  static com.uber.cadence.entities.ChildWorkflowExecutionStartedEventAttributes childWorkflowExecutionStartedEventAttributes(
  ...
  static com.uber.cadence.entities.DecisionTaskFailedEventAttributes decisionTaskFailedEventAttributes(
    ...
    com.uber.cadence.entities.DecisionTaskFailedEventAttributes res = new com.uber.cadence.entities.DecisionTaskFailedEventAttributes();
    res.setScheduledEventId(t.getScheduledEventId());
    res.setStartedEventId(t.getStartedEventId());
  ...
  static com.uber.cadence.entities.DecisionTaskScheduledEventAttributes decisionTaskScheduledEventAttributes(
    ...
    com.uber.cadence.entities.DecisionTaskScheduledEventAttributes res = new com.uber.cadence.entities.DecisionTaskScheduledEventAttributes();
    res.setTaskList(taskList(t.getTaskList()));
    res.setStartToCloseTimeoutSeconds(durationToSeconds(t.getStartToCloseTimeout()));
    res.setAttempt(t.getAttempt());
    return res;
  ...
  static com.uber.cadence.entities.DecisionTaskStartedEventAttributes decisionTaskStartedEventAttributes(
    ...
    com.uber.cadence.entities.DecisionTaskStartedEventAttributes res = new com.uber.cadence.entities.DecisionTaskStartedEventAttributes();
    res.setScheduledEventId(t.getScheduledEventId());
    res.setIdentity(t.getIdentity());
    res.setRequestId(t.getRequestId());
    return res;
  ...
  static com.uber.cadence.entities.DecisionTaskCompletedEventAttributes decisionTaskCompletedEventAttributes(
    ...
    com.uber.cadence.entities.DecisionTaskCompletedEventAttributes res = new com.uber.cadence.entities.DecisionTaskCompletedEventAttributes();
    res.setScheduledEventId(t.getScheduledEventId());
    res.setStartedEventId(t.getStartedEventId());
    res.setIdentity(t.getIdentity());
    res.setBinaryChecksum(t.getBinaryChecksum());
  ...
  static com.uber.cadence.entities.DecisionTaskTimedOutEventAttributes decisionTaskTimedOutEventAttributes(
    ...
    com.uber.cadence.entities.DecisionTaskTimedOutEventAttributes res = new com.uber.cadence.entities.DecisionTaskTimedOutEventAttributes();
    res.setScheduledEventId(t.getScheduledEventId());
    res.setStartedEventId(t.getStartedEventId());
  ...
  static com.uber.cadence.entities.MarkerRecordedEventAttributes markerRecordedEventAttributes(
    ...
    com.uber.cadence.entities.MarkerRecordedEventAttributes res = new com.uber.cadence.entities.MarkerRecordedEventAttributes();
  ...
  static com.uber.cadence.entities.RequestCancelExternalWorkflowExecutionInitiatedEventAttributes
    ...
    com.uber.cadence.entities.RequestCancelExternalWorkflowExecutionInitiatedEventAttributes res =
        new com.uber.cadence.entities.RequestCancelExternalWorkflowExecutionInitiatedEventAttributes();
    res.setDecisionTaskCompletedEventId(t.getDecisionTaskCompletedEventId());
    res.setDomain(t.getDomain());
    res.setWorkflowExecution(workflowExecution(t.getWorkflowExecution()));
    res.setControl(byteStringToArray(t.getControl()));
  ...
  static com.uber.cadence.entities.TimerCanceledEventAttributes timerCanceledEventAttributes(
    ...
    com.uber.cadence.entities.TimerCanceledEventAttributes res = new com.uber.cadence.entities.TimerCanceledEventAttributes();
    res.setTimerId(t.getTimerId());
    res.setStartedEventId(t.getStartedEventId());
    res.setDecisionTaskCompletedEventId(t.getDecisionTaskCompletedEventId());
    res.setIdentity(t.getIdentity());
  ...
  static com.uber.cadence.entities.TimerFiredEventAttributes timerFiredEventAttributes(
    ...
    com.uber.cadence.entities.TimerFiredEventAttributes res = new com.uber.cadence.entities.TimerFiredEventAttributes();
    res.setTimerId(t.getTimerId());
    res.setStartedEventId(t.getStartedEventId());
    return res;
  }
  ...
  static com.uber.cadence.entities.TimerStartedEventAttributes timerStartedEventAttributes(
    ...
    com.uber.cadence.entities.TimerStartedEventAttributes res = new com.uber.cadence.entities.TimerStartedEventAttributes();
    res.setTimerId(t.getTimerId());
  ...
  static com.uber.cadence.entities.WorkflowExecutionCanceledEventAttributes workflowExecutionCanceledEventAttributes(
    ...
    com.uber.cadence.entities.WorkflowExecutionCanceledEventAttributes res = new com.uber.cadence.entities.WorkflowExecutionCanceledEventAttributes();
    res.setDecisionTaskCompletedEventId(t.getDecisionTaskCompletedEventId());
    res.setDetails(payload(t.getDetails()));
    return res;
  }

  static com.uber.cadence.entities.WorkflowExecutionCompletedEventAttributes workflowExecutionCompletedEventAttributes(
    ...
    com.uber.cadence.entities.WorkflowExecutionCompletedEventAttributes res = new com.uber.cadence.entities.WorkflowExecutionCompletedEventAttributes();
    res.setResult(payload(t.getResult()));
    res.setDecisionTaskCompletedEventId(t.getDecisionTaskCompletedEventId());
    return res;
  }
  ...
  static com.uber.cadence.entities.WorkflowExecutionFailedEventAttributes workflowExecutionFailedEventAttributes(
    ...
    com.uber.cadence.entities.WorkflowExecutionFailedEventAttributes res = new com.uber.cadence.entities.WorkflowExecutionFailedEventAttributes();
    res.setReason(failureReason(t.getFailure()));
    res.setDetails(failureDetails(t.getFailure()));
    res.setDecisionTaskCompletedEventId(t.getDecisionTaskCompletedEventId());
    return res;
  ...
  static com.uber.cadence.entities.WorkflowExecutionSignaledEventAttributes workflowExecutionSignaledEventAttributes(
    ...
    com.uber.cadence.entities.WorkflowExecutionSignaledEventAttributes res = new com.uber.cadence.entities.WorkflowExecutionSignaledEventAttributes();
    res.setSignalName(t.getSignalName());
    res.setInput(payload(t.getInput()));
    res.setIdentity(t.getIdentity());
    return res;
  ...
  static com.uber.cadence.entities.WorkflowExecutionStartedEventAttributes workflowExecutionStartedEventAttributes(
    ...
    com.uber.cadence.entities.WorkflowExecutionStartedEventAttributes res = new com.uber.cadence.entities.WorkflowExecutionStartedEventAttributes();
    res.setWorkflowType(workflowType(t.getWorkflowType()));
  ...
  static com.uber.cadence.entities.WorkflowExecutionTerminatedEventAttributes workflowExecutionTerminatedEventAttributes(
    ...
    com.uber.cadence.entities.WorkflowExecutionTerminatedEventAttributes res = new com.uber.cadence.entities.WorkflowExecutionTerminatedEventAttributes();
    res.setReason(t.getReason());
    res.setDetails(payload(t.getDetails()));
    res.setIdentity(t.getIdentity());
    return res;
  ...
  static com.uber.cadence.entities.WorkflowExecutionTimedOutEventAttributes workflowExecutionTimedOutEventAttributes(
    ...
    com.uber.cadence.entities.WorkflowExecutionTimedOutEventAttributes res = new com.uber.cadence.entities.WorkflowExecutionTimedOutEventAttributes();
    res.setTimeoutType(timeoutType(t.getTimeoutType()));
    return res;
  }
}
