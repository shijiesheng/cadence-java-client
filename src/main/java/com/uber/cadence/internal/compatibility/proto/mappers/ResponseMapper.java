...
public class ResponseMapper {
    ...
    public static com.uber.cadence.entities.StartWorkflowExecutionResponse startWorkflowExecutionResponse(
    ...
    public static com.uber.cadence.entities.StartWorkflowExecutionAsyncResponse startWorkflowExecutionAsyncResponse(
        StartWorkflowExecutionAsyncResponse t) {
    ...
    public static com.uber.cadence.entities.DescribeTaskListResponse describeTaskListResponse(
      ...
      com.uber.cadence.entities.DescribeTaskListResponse describeTaskListResponse = new com.uber.cadence.entities.DescribeTaskListResponse();
    ...
    public static com.uber.cadence.entities.DescribeWorkflowExecutionResponse describeWorkflowExecutionResponse(
    ...
    public static com.uber.cadence.entities.GetSearchAttributesResponse getSearchAttributesResponse(
      ...
      com.uber.cadence.entities.GetSearchAttributesResponse getSearchAttributesResponse = new com.uber.cadence.entities.GetSearchAttributesResponse();
      getSearchAttributesResponse.setKeys(indexedValueTypeMap(t.getKeysMap()));
      return getSearchAttributesResponse;
    }

    public static com.uber.cadence.entities.GetWorkflowExecutionHistoryResponse getWorkflowExecutionHistoryResponse(
        GetWorkflowExecutionHistoryResponse t) {
      if (t == null) {
        return null;
      }
      com.uber.cadence.entities.GetWorkflowExecutionHistoryResponse getWorkflowExecutionHistoryResponse =
    ...
    public static com.uber.cadence.entities.ListArchivedWorkflowExecutionsResponse listArchivedWorkflowExecutionsResponse(
        ListArchivedWorkflowExecutionsResponse t) {
      if (t == null) {
        return null;
      }
      com.uber.cadence.entities.ListArchivedWorkflowExecutionsResponse res = new com.uber.cadence.entities.ListArchivedWorkflowExecutionsResponse();
    ...
    public static com.uber.cadence.entities.ListClosedWorkflowExecutionsResponse listClosedWorkflowExecutionsResponse(
        ListClosedWorkflowExecutionsResponse t) {
      if (t == null) {
        return null;
      }
      com.uber.cadence.entities.ListClosedWorkflowExecutionsResponse res = new com.uber.cadence.entities.ListClosedWorkflowExecutionsResponse();
      res.setExecutions(workflowExecutionInfoArray(t.getExecutionsList()));
      res.setNextPageToken(byteStringToArray(t.getNextPageToken()));
      return res;
    }

    public static com.uber.cadence.entities.ListOpenWorkflowExecutionsResponse listOpenWorkflowExecutionsResponse(
        ListOpenWorkflowExecutionsResponse t) {
      if (t == null) {
        return null;
      }
      com.uber.cadence.entities.ListOpenWorkflowExecutionsResponse res = new com.uber.cadence.entities.ListOpenWorkflowExecutionsResponse();
      res.setExecutions(workflowExecutionInfoArray(t.getExecutionsList()));
      res.setNextPageToken(byteStringToArray(t.getNextPageToken()));
      return res;
    }

    public static com.uber.cadence.entities.ListTaskListPartitionsResponse listTaskListPartitionsResponse(
        ListTaskListPartitionsResponse t) {
      if (t == null) {
        return null;
      }
      com.uber.cadence.entities.ListTaskListPartitionsResponse res = new com.uber.cadence.entities.ListTaskListPartitionsResponse();
    ...
    public static com.uber.cadence.entities.ListWorkflowExecutionsResponse listWorkflowExecutionsResponse(
        ListWorkflowExecutionsResponse t) {
      if (t == null) {
        return null;
      }
      com.uber.cadence.entities.ListWorkflowExecutionsResponse res = new com.uber.cadence.entities.ListWorkflowExecutionsResponse();
      res.setExecutions(workflowExecutionInfoArray(t.getExecutionsList()));
      res.setNextPageToken(byteStringToArray(t.getNextPageToken()));
      return res;
    }
    ...
    public static com.uber.cadence.entities.PollForActivityTaskResponse pollForActivityTaskResponse(
      ...
      com.uber.cadence.entities.PollForActivityTaskResponse res = new com.uber.cadence.entities.PollForActivityTaskResponse();
    ...
    public static com.uber.cadence.entities.PollForDecisionTaskResponse pollForDecisionTaskResponse(
      ...
      com.uber.cadence.entities.PollForDecisionTaskResponse res = new com.uber.cadence.entities.PollForDecisionTaskResponse();
      res.setTaskToken(byteStringToArray(t.getTaskToken()));
      res.setWorkflowExecution(workflowExecution(t.getWorkflowExecution()));
      res.setWorkflowType(workflowType(t.getWorkflowType()));
    ...
    public static com.uber.cadence.entities.QueryWorkflowResponse queryWorkflowResponse(
      ...
      com.uber.cadence.entities.QueryWorkflowResponse res = new com.uber.cadence.entities.QueryWorkflowResponse();
      res.setQueryResult(payload(t.getQueryResult()));
      res.setQueryRejected(queryRejected(t.getQueryRejected()));
      return res;
    }

    public static com.uber.cadence.entities.RecordActivityTaskHeartbeatResponse recordActivityTaskHeartbeatByIdResponse(
        RecordActivityTaskHeartbeatByIDResponse t) {
      if (t == null) {
        return null;
      }
      com.uber.cadence.entities.RecordActivityTaskHeartbeatResponse res = new com.uber.cadence.entities.RecordActivityTaskHeartbeatResponse();
      res.setCancelRequested(t.getCancelRequested());
      return res;
    }

    public static com.uber.cadence.entities.RecordActivityTaskHeartbeatResponse recordActivityTaskHeartbeatResponse(
        RecordActivityTaskHeartbeatResponse t) {
      if (t == null) {
        return null;
      }
      com.uber.cadence.entities.RecordActivityTaskHeartbeatResponse res = new com.uber.cadence.entities.RecordActivityTaskHeartbeatResponse();
    ...
    public static com.uber.cadence.entities.ResetWorkflowExecutionResponse resetWorkflowExecutionResponse(
        ResetWorkflowExecutionResponse t) {
      if (t == null) {
        return null;
      }
      com.uber.cadence.entities.ResetWorkflowExecutionResponse res = new com.uber.cadence.entities.ResetWorkflowExecutionResponse();
    ...
    public static com.uber.cadence.entities.RespondDecisionTaskCompletedResponse respondDecisionTaskCompletedResponse(
        RespondDecisionTaskCompletedResponse t) {
      if (t == null) {
        return null;
      }
      com.uber.cadence.entities.RespondDecisionTaskCompletedResponse res = new com.uber.cadence.entities.RespondDecisionTaskCompletedResponse();
    ...
    public static com.uber.cadence.entities.CountWorkflowExecutionsResponse countWorkflowExecutionsResponse(
        CountWorkflowExecutionsResponse t) {
      if (t == null) {
        return null;
      }
      com.uber.cadence.entities.CountWorkflowExecutionsResponse res = new com.uber.cadence.entities.CountWorkflowExecutionsResponse();
    ...
    public static com.uber.cadence.entities.DescribeDomainResponse describeDomainResponse(
      ...
      com.uber.cadence.entities.DescribeDomainResponse response = new com.uber.cadence.entities.DescribeDomainResponse();
      ...
      com.uber.cadence.entities.DomainConfiguration domainConfiguration = new com.uber.cadence.entities.DomainConfiguration();
      ...
      com.uber.cadence.entities.DomainReplicationConfiguration replicationConfiguration = new com.uber.cadence.entities.DomainReplicationConfiguration();
    ...
    public static com.uber.cadence.entities.ListDomainsResponse listDomainsResponse(
      ...
      com.uber.cadence.entities.ListDomainsResponse res = new com.uber.cadence.entities.ListDomainsResponse();
      res.setDomains(describeDomainResponseArray(t.getDomainsList()));
      res.setNextPageToken(byteStringToArray(t.getNextPageToken()));
      return res;
    }

    public static com.uber.cadence.entities.StartWorkflowExecutionResponse signalWithStartWorkflowExecutionResponse(
        SignalWithStartWorkflowExecutionResponse t) {
      if (t == null) {
        return null;
      }
      com.uber.cadence.entities.StartWorkflowExecutionResponse startWorkflowExecutionResponse =
    ...
    public static com.uber.cadence.entities.SignalWithStartWorkflowExecutionAsyncResponse
      ...
      return t == null ? null : new com.uber.cadence.entities.SignalWithStartWorkflowExecutionAsyncResponse();
    }
    ...
    public static com.uber.cadence.entities.UpdateDomainResponse updateDomainResponse(
      ...
      com.uber.cadence.entities.UpdateDomainResponse updateDomainResponse = new com.uber.cadence.entities.UpdateDomainResponse();
      com.uber.cadence.entities.DomainInfo domainInfo = new com.uber.cadence.entities.DomainInfo();
