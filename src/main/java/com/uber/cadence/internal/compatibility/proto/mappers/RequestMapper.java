...
import com.uber.cadence.entities.DomainConfiguration;
import com.uber.cadence.entities.DomainReplicationConfiguration;
import com.uber.cadence.entities.UpdateDomainInfo;
...
public class RequestMapper {
  ...
  public static ListDomainsRequest listDomainsRequest(com.uber.cadence.entities.ListDomainsRequest t) {
    if (t == null) {
      return null;
    }
    ListDomainsRequest.Builder request = ListDomainsRequest.newBuilder().setPageSize(t.getPageSize());
    if (t.getNextPageToken() != null) {
      request.setNextPageToken(arrayToByteString(t.getNextPageToken()));
    }
    return request.build();
  ...
  public static QueryWorkflowRequest queryWorkflowRequest(com.uber.cadence.entities.QueryWorkflowRequest t) {
    if (t == null) {
      return null;
    }
  ...
  public static UpdateDomainRequest updateDomainRequest(com.uber.cadence.entities.UpdateDomainRequest t) {
    if (t == null) {
      return null;
    }
    Builder request =
