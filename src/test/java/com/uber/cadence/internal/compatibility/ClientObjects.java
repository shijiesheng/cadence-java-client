...
public class ClientObjects {
        ...
        public static final WorkflowType WORKFLOW_TYPE =
                new WorkflowType().setName("workflowType");
        ...
        public static final WorkflowQuery WORKFLOW_QUERY =
                new WorkflowQuery().setQueryType("queryType").setQueryArgs("queryArgs".getBytes(StandardCharsets.UTF_8));
        ...
        public static final ResetPointInfo RESET_POINT_INFO =
                new ResetPointInfo()
                        ...
                        .setRunId("runId")
                        .setCreatedTimeNano((long)1)
                        .setResettable(true)
                        .setExpiringTimeNano((long)2)
                        .setFirstDecisionCompletedId((long)3);
        ...
        public static final PollerInfo POLLER_INFO =
                new PollerInfo().setIdentity("identity").setLastAccessTime((long)1).setRatePerSecond(2.0);
        public static final TaskIDBlock TASK_ID_BLOCK = new TaskIDBlock().setStartID((long)1).setEndID((long)2);
        public static final TaskListStatus TASK_LIST_STATUS =
                new TaskListStatus()
                        .setTaskIDBlock(TASK_ID_BLOCK)
                        .setAckLevel((long)1)
                        .setBacklogCountHint((long)2)
                        .setReadLevel((long)3)
        ...
        public static final PendingActivityInfo PENDING_ACTIVITY_INFO =
                new PendingActivityInfo()
                        ...
                        .setLastHeartbeatTimestamp((long)1)
                        .setLastStartedTimestamp((long)2)
                        .setAttempt(3)
                        .setMaximumAttempts(4)
                        .setScheduledTimestamp((long)5)
                        .setExpirationTimestamp((long)6)
        ...
        public static final PendingDecisionInfo PENDING_DECISION_INFO =
                new PendingDecisionInfo()
                        ...
                        .setScheduledTimestamp((long)1)
                        .setStartedTimestamp((long)2)
                        .setAttempt(3)
                        .setOriginalScheduledTimestamp((long)4);
        ...
        public static final ActivityLocalDispatchInfo ACTIVITY_LOCAL_DISPATCH_INFO =
                new ActivityLocalDispatchInfo()
                        ...
                        .setScheduledTimestamp((long)1)
                        .setStartedTimestamp((long)2)
                        .setScheduledTimestampOfThisAttempt((long)3)
        ...
        public static final BadBinaryInfo BAD_BINARY_INFO =
                new BadBinaryInfo().setReason("reason").setOperator("operator").setCreatedTimeNano((long)3);
        ...
        public static final StartTimeFilter START_TIME_FILTER =
                new StartTimeFilter().setEarliestTime((long)2).setLatestTime((long)3);
                ...
                new Decision()
                        ...
                        .setStartTimerDecisionAttributes(
                                new StartTimerDecisionAttributes()
                                        .setTimerId("timerId")
                                        .setStartToFireTimeoutSeconds((long)2));
        ...
        public static final WorkflowExecutionStartedEventAttributes
                ...
                new WorkflowExecutionStartedEventAttributes()
                        ...
                        .setParentInitiatedEventId((long)1)
                        .setTaskList(TASK_LIST)
                        .setInput(utf8("input").array())
        ...
        public static final WorkflowExecutionCompletedEventAttributes
                ...
                new WorkflowExecutionCompletedEventAttributes()
                        ...
                        .setDecisionTaskCompletedEventId((long)1);
        ...
        public static final SignalWithStartWorkflowExecutionRequest
        ...
        public static final PollForDecisionTaskResponse POLL_FOR_DECISION_TASK_RESPONSE =
                new PollForDecisionTaskResponse()
                        ...
                        .setWorkflowExecution(WORKFLOW_EXECUTION)
                        .setWorkflowType(WORKFLOW_TYPE)
                        .setPreviousStartedEventId((long)1)
                        .setStartedEventId((long)2)
                        .setAttempt((long)3)
                        .setBacklogCountHint((long)4)
                        .setHistory(HISTORY)
                        .setNextPageToken(utf8("nextPageToken").array())
                        .setQuery(WORKFLOW_QUERY)
                        .setWorkflowExecutionTaskList(TASK_LIST)
                        .setScheduledTimestamp((long)5)
                        .setStartedTimestamp((long)6)
                        .setQueries(ImmutableMap.of("query", WORKFLOW_QUERY))
                        .setNextEventId((long)7);
        ...
        public static final CountWorkflowExecutionsResponse COUNT_WORKFLOW_EXECUTIONS_RESPONSE =
                new CountWorkflowExecutionsResponse().setCount((long)1000);
